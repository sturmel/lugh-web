<template>
    <section class="technologies flex flex-col items-center justify-center w-full h-full perspective-[1000px]"
        ...
        <h2
            class="technologies__title text-transparent w-full text-6xl m-auto ml-0 mb-15 font-bold text-shadow-md text-shadow-white/25">
        ...
        <div class="flex flex-col items-center justify-center w-full h-full mb-14">
            <h3
                class="technologies__subtitle text-transparent text-4xl  m-auto ml-0 mt-0 mb-5 font-bold text-shadow-md text-shadow-white/25">
                CMS : Des fondations solides pour votre contenu</h3>
            <p class="text-xl technologies__description text-transparent">J'exploite des systèmes de gestion de contenu
            ...
            <div class="w-full flex flex-wrap justify-center items-center m-auto mt-10">
                <div class="technologies__container__card p-10">
                    ...
                    un vaste écosystème de thèmes et d'extensions pour tous types de sites."
                        imageUrl="/images/logo/WordPress.webp" hexColor="#0a369d"
                        imageAlt="Logo WordPress" />
                </div>
                <div class="technologies__container__card p-10">
                    ...
                    API-first et la diffusion de contenu sur de multiples plateformes."
                        imageUrl="/images/logo/Strapi.webp" hexColor="#0a369d" 
                        imageAlt="Logo WordPress" />
                </div>
                <div class="technologies__container__card p-10">
                    ...
                    visuellement riches et performants, avec un contrôle total sur le design."
                        imageUrl="/images/logo/Webflow.webp" hexColor="#0a369d" 
                        imageAlt="Logo WordPress" />
                </div>
                <div class="technologies__container__card p-10">
                    ...
                    avec des architectures modernes, offrant une gestion de contenu structurée et collaborative."
                        imageUrl="/images/logo/Contentful.webp" hexColor="#0a369d"
                        imageAlt="Logo WordPress" />
                </div>
            </div>
        </div>
        <div class="flex flex-col items-center justify-center w-full h-full mb-14">
            <h3
                class="technologies__subtitle text-4xl text-transparent m-auto ml-0 mt-0 mb-5 font-bold text-shadow-md text-shadow-white/25">
                Frameworks : L'Architecture de vos projets web et applications</h3>
            <p class="text-xl technologies__description text-transparent">Je construis des applications web et des
            ...
            <div class="w-full flex flex-wrap justify-center items-center m-auto mt-10">
                <div class="technologies__container__card p-10">
                    ...
                    l'industrie, idéal pour les projets de grande envergure et les API performantes."
                        imageUrl="/images/logo/Symfony.webp" hexColor="#0a369d" 
                        imageAlt="Logo WordPress" />
                </div>
                <div class="technologies__container__card p-10">
                    ...
                    universelles (SSR, SSG, SPA) avec une excellente performance et un SEO optimisé."
                        imageUrl="/images/logo/Nuxt.webp" hexColor="#0a369d"
                        imageAlt="Logo Nuxt" />
                </div>
                <div class="technologies__container__card p-10">
                    ...
                    d'applications web complexes et sécurisées avec une syntaxe expressive."
                        imageUrl="/images/logo/Laravel.webp" hexColor="#0a369d" 
                ...
                <div class="technologies__container__card p-10">
                    <LazyCardTechnologie title="Flutter"
                        ...
                        imageUrl="/images/logo/Flutter.webp" hexColor="#0a369d" 
                        imageAlt="Logo Flutter" />
                </div>
                <div class="technologies__container__card p-10">
                ...
                <div class="technologies__container__card p-10">
                    <LazyCardTechnologie title="Vue.js"
                        text="Un framework UI open-source de Google pour créer des applications magnifiques et performantes pour mobile (iOS et Android), à partir d'une seule base de code."
                        imageUrl="/images/logo/VueJs.webp" hexColor="#0a369d" 
                        imageAlt="Logo VueJs" />
                </div>
                <div class="technologies__container__card p-10">
                    <LazyCardTechnologie title="FlutterFlow"
                        ...
                        imageUrl="/images/logo/FlutterFlow.webp" hexColor="#0a369d" 
                        imageAlt="Logo FlutterFlow" />
                </div>
                <div class="technologies__container__card p-10">
                    <LazyCardTechnologie title="Gin"
                        ...
                        imageUrl="/images/logo/Gin.webp" hexColor="#0a369d" 
                        imageAlt="Logo Gin" />
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col items-center justify-center w-full h-full mb-14">
            ...
            <p class="text-xl technologies__description text-transparent">Ma maîtrise des langages de programmation
            ...
            <div class="w-full flex flex-wrap justify-center items-center m-auto mt-10">
                <div class="technologies__container__card p-10">
                    ...
                    web, notamment avec des CMS comme WordPress et des frameworks comme Laravel et Symfony."
                        imageUrl="/images/logo/Php.webp" hexColor="#0a369d"
                        imageAlt="Logo PHP" />
                </div>
                <div class="technologies__container__card p-10">
                    <LazyCardTechnologie title="JavaScript"
                        ...
                        imageUrl="/images/logo/JavaScript.webp" hexColor="#0a369d" 
                ...
                <div class="technologies__container__card p-10">
                    <LazyCardTechnologie title="TypeScript"
                        ...
                        imageUrl="/images/logo/TypeScript.webp" hexColor="#0a369d" 
                        imageAlt="Logo TypeScript" />
                </div>
                <div class="technologies__container__card p-10">
                    <LazyCardTechnologie title="SQL"
                        ...
                        imageUrl="/images/logo/Sql.webp" hexColor="#0a369d" 
                        imageAlt="Logo SQL" />
                </div>
                <div class="technologies__container__card p-10">
                    <LazyCardTechnologie title="GoLang"
                        ...
                        imageUrl="/images/logo/GoLang.webp" hexColor="#0a369d" 
                        imageAlt="Logo GoLang" />
                </div>
                <div class="technologies__container__card p-10">
                    <LazyCardTechnologie title="Dart"
                        ...
                        imageUrl="/images/logo/Dart.webp" hexColor="#0a369d" 
                        imageAlt="Logo Dart" />
                </div>
            </div>
        </div>
